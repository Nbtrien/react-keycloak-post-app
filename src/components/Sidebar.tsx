        ...
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              {keycloak?.authenticated && keycloak.tokenParsed?.post_roles && (
                <>
                  {keycloak.tokenParsed.post_roles.includes("post_user") && (
                    <>
                      <li className="items-center">
                        <Link
                          className="text-pink-500 hover:text-pink-600 text-xs uppercase py-3 font-bold block"
                          to="/user/create-posts"
                        >
                  ...
                  {keycloak.tokenParsed.post_roles.includes("post_admin") && (
                    <>
                      <li className="items-center">
                        <Link
                          className="text-pink-500 hover:text-pink-600 text-xs uppercase py-3 font-bold block"
